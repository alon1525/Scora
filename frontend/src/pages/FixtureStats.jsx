...
const FixtureStats = () => {
  ...
  const homeTeamName = getCleanTeamName(fixture.home_team_name);
  const awayTeamName = getCleanTeamName(fixture.away_team_name);

  return (
    <div className="fixture-stats-page">
      {/* Header */}
      <header className="fixture-stats-header">
        <button className="fixture-stats-back" onClick={() => navigate(-1)}>
          <span className="material-symbols-outlined">arrow_back</span>
        </button>
        <div className="fixture-stats-title">
          <h1>Fixture Stats</h1>
          ...
          <div className="fixture-stats-vs">
            {fixture.status === 'FINISHED' ? (
              ...
              <span className="fixture-stats-time">
                {fixture.match_date ? new Date(fixture.match_date).toLocaleDateString() : 'TBD'}
              </span>
            )}
          </div>
          <div className="fixture-stats-team">
      ...
      {stats && (
        <div className="fixture-stats-content">
          ...
          <div className="fixture-stats-section">
            <h2 className="fixture-stats-section-title">
